...
Für die Bewältigung dieser Herausforderung veröffentlichte die Plattform Industrie 4.0 das \glqq Referenzarchitekturmodell Industrie 4.0\grqq{} (RAMI 4.0) sowie das Konzept zur \glqq Industrie-4.0-Komponente\grqq{}.

\paragraph{RAMI 4.0} ist ein Rahmenwerk, in denen Standards und Normen verortet und auf den jeweiligen Anwendungsfall angewandt werden können. Es ist ein dreidimensionales Modell, erstellt in Anlehnung auf das Smart Grid Modell, welches die wichtigsten Funktionalitäten aus den verschiedenen Disziplinen in Schichten kapselt.
