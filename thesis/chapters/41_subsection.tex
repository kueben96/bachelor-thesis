...
\paragraph{Cloud Computing} stellt die IT-Infrastruktur, die ein Industrie 4.0-fähiges \ac{cpss} benötigt. Der \textit{Datentransport} vom Gerät hat oftmals eine Cloud-Plattform als Ziel, auf der die \textit{Datenhaltung} stattfindet. Die in die Cloud auslagerbaren Dienste wie Big Data oder Analytics ermöglichen \textit{Analysen} durch Aggregationen und Auswertungen \citep{Roth2016}.

Durch kombinierte Nutzung erzeugt sich Mehrwert und man kann all diese Dienste auf die Cloud auslagern, ohne Rechenleistung zu beachten. Dafür haben die größten Cloud-Anbieter Rechenzentrum weltweit aufgebaut. Man muss sich nicht mehr um Hardware kümmern.

\begin{itemize}
  \item Big Data/Machine Learning
  \item Blockchain
  \item Machine Learning
  \item diese technologgischen Begrifflichkeiten kurz erläutern, um sie in den KOntext einzuordnen
  \item Kontext: alle Verfügbar in der Cloud, weil IOT die Daten erzeugt und sammelt, nun können die anderen Dienste vielleicht mehr damit anfangen, außer zu monitoren und zu steuern
  \item
\end{itemize}

Warum die Cloud die tragende Säule der digitalen Transformation ist und durch welche Technologien sie sich auszeichnet, wird in 2.2.4 ausführlicher erläutert.


Welche Technologien sind denn als evolutionär zu bezeichnen?
